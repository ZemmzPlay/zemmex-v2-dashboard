 ...
 */
export function BadgeCard({ event, name, line1, line2, ticket, publicId, gate, logoUrl }: { event: Event; name: string; line1?: string; line2?: string; ticket?: string; publicId: number; gate?: string; logoUrl?: string | null }) {
