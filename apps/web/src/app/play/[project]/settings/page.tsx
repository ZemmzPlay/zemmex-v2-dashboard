        ...
        <>
          <SimpleForm action={saveProject.bind(null, slug)} submitLabel="Save" canEdit={manage}>
            <section className="fsec">
              ...
              <div className="fld"><label>Web address</label><p className="m-0 text-[14px]"><a href={`/p/${slug}`} target="_blank" rel="noopener">{slug}.zemmz.gg</a></p><span className="help">The address can’t change once players have it. To use your own domain, <Link href="/contact?topic=play-domain">contact us</Link>.</span></div>
